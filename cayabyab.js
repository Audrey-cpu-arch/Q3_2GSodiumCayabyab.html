...
process.stdin.on('data', function (data)  { 
  ...
  console.log(removeElements(input)); // complete removeElements() and it should return a value. See Instructions below   process.exit(); });
...
function removeElements (a){
  ...
  getArray();
  newArray = getArray().slice(0,a);
  
  console.log(getArray().length-newArray.length);
